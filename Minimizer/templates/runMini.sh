...
# loop on REC
#============ 
foreach PROT ('\ls $SEPDIR/1KKL_l_b.pdb')
set PROT1={$PROT:t:r}
echo $PROT1
set PROTNAME1=$PROT1
...
# loop on LIG
#============
foreach PROTT ('\ls $SEPDIR/1KKL_r_b.pdb')
set PROT2={$PROTT:t:r}
set PROTNAME2=$PROT2
...
# !!!!!!!
# run modified version for Meet-U (MAXDo1 (PlosCB 2013 version) !!! modified 05/09/2016 --> minimization only)
#=============================================================================================================
